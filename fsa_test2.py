...
More complement tests (a*b+c*):

    >>> fsa2 = DFSA( { 0: { 'a':0, 'b':1 },     # state 0  a => 0, b => 1
    ...                1: { 'b':1, 'c':2 },     # state 1  b => 1, c => 2
    ...                2: { 'c':2 } },          # state 2  c => 2
    ...               [ 1, 2 ])
    >>> fsa2.recognize('aaabbbccc')
    True
    >>> fsa2.recognize('bbb')
    True
    >>> fsa2.recognize('ab')
